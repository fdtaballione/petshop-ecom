          ...
          <div className="flex flex-col md:flex-row md:space-x-4 md:space-y-0 space-y-6 bg-blue-800 w-full max-w-4xl p-8 rounded-xl shadow-lg text-white">
            <div className=" flex flex-col space-y-8 justify-between">
              <div>
                ...
                <p className="pt-2 text-amber-300 ">
                  Hacenos tu pedio o dejanos tu consulta.
                </p>
              </div>
              ...
              <div className="inline-flex sapace-x-2 items-center">
                <img
                  src="https://img.icons8.com/ios/50/000000/schedule-mail.png"
                  width={30}
                ></img>
              ...
              <div className="inline-flex sapace-x-2 items-center">
                <img
                  src="https://img.icons8.com/ios/50/000000/marker-o.png"
                  width={30}
                ></img>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 text-gray-600">
              <from action="" className="flex flex-col space-y-4">
                ...
                <button
                  className="inline-block self-end bg-blue-800 text-white font-bold rounded-lg px-6 py-3
                                uppercase text-sm"
                >
                  {" "}
                  Enviar Mensaje
